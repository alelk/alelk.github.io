...
export const skills = [
  {
    titleId: "skills.scala",
    defaultTitle: "Scala Development",
    level: 80,
    skills: [
      {
        titleId: "skills.scala.scala",
        descriptionId: "skills.scala.scala_description",
        defaultTitle: "Scala",
        level: 90,
        href: "https://www.scala-lang.org/"
      }, {
        titleId: "skills.scala.sbt",
        descriptionId: "skills.scala.sbt_description",
        defaultTitle: "SBT",
        level: 50,
    ...
    groups: [
      {
        titleId: "skills.scala.libraries",
        defaultTitle: "Scala Libraries",
        level: 60,
        skills: [
          {
            titleId: "skills.scala.libraries.akkaHttp",
            descriptionId: "skills.scala.libraries.akkaHttp_description",
            defaultTitle: "Akka HTTP",
            level: 70,
            href: "https://doc.akka.io/docs/akka-http/current/"
          },
          {
            titleId: "skills.scala.libraries.slick",
            descriptionId: "skills.scala.libraries.slick_description",
            defaultTitle: "Slick",
            level: 70,
            href: "http://slick.lightbend.com/"
          }
        ]
      }
    ]
